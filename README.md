...
### summary_message
- 功能：对消息进行总结和扩展
- 支持命令：概括, 扫盲, 质疑, 安慰/夸夸, 鸣式, 说明, 丝之歌, 何式, 公式, ocr, 词典, 百科, 网络梗, 解析, 宫崎英高小故事, 利好
...
- 支持命令：xqm {文本}, 谁在打 {文本}
- 特点：支持白名单管理，可与外部语言模型服务对接，调用的是 [rachibot](https://github.com/xqm32/rachibot)

### guarder
- 功能：消息审查与自动翻译
- 支持命令：无（被动触发）
- 特点：使用腾讯云进行文本审查，自动检测日语并翻译成中文，支持群聊黑白名单管理
